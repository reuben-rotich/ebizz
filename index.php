...
<!-- Body -->
<body class="metro" style="background-image: url('images/bg.png'); background-repeat: no-repeat; background-size:cover;">
	<nav class="navigation-bar gray">
	...
	<div class="grid">
		<div class="row">
			<div class="span9 offset1 bg-blue"> 
				<img src="images/d.jpg"  height="80px"/>
			</div>
			<div class="span4 offset1">
				<p><span style="font-size:60px; font-weight:900; font-family:stencil;"> JUMUIKA </span> </p><br>
				<span class="subheader fg-blue"> Hot Deals </span>
			</div>
		...
		<a href="info.php" ><button class="command-button danger large" onclick="info.php"> Information</button>
		</div>
		</div>
		<div class="span12 overlay bg-dark offset1" style="opacity:0.5;">
			<marquee>
				<span class="fg-amber" style="font-weight:500; font-size:60px">YOU ARE ALL WELCOMED </span>
			</marquee>
		</div>
		</div>
	</div>
